...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-DGR9MWU6.mjs");
...
var manifest = { "2e3178a40b575a438102068b900ac4c8c2e16553f9064ac34edce6af672213a4": {
	functionName: "submitBrief_createServerFn_handler",
	importer: () => import("./submit-brief-D8c_u7C3.mjs")
} };
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-HkZoSDfY.mjs").then((n) => n.t),
