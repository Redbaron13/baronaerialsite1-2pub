      ...
      <div className="site-container">
        <Reveal>
          ...
          <p className={cn("lead mt-4 max-w-[62ch]", light ? "text-ink-muted" : "text-fg-soft")}>
            {brand.altTagline}. After the aircraft is down, frames are culled, aligned,
            reconstructed, and packed to the specification in the brief. 3D site models and
            construction tracking live here — not as decoration, as the reason the flight was
            planned.
          </p>
        </Reveal>
        ...
        <div className="mt-12 grid items-center gap-10 md:grid-cols-2 md:gap-14">
          ...
          <Reveal delay={80}>
            ...
            <h3
              className={cn(
                "mt-2 text-[clamp(1.6rem,3vw,2.4rem)]",
                light ? "text-ink-text" : "text-fg",
              )}
            >
            ...
            >
              Separate the orthomosaic, elevation visualization and capture coverage. Each answers a
              different question about the same site. Explore the layers in three dimensions, or
              isolate an output to examine the source image.
            </p>
            <Link
              to="/work/$slug"
        ...
        <div className="mt-20 grid items-start gap-10 md:grid-cols-2 md:gap-14">
          <Reveal className="md:order-2">
            ...
            <div className="mt-3 grid grid-cols-3 gap-2">
              {[
                [
                  "/media/overpass-oblique.webp",
                  "Dump trucks on the North Munn Avenue Bridge deck over I-280",
                ],
                [
                  "/media/brick-church-village.webp",
                  "The Crossings at Brick Church Station from the I-280 dirt",
                ],
                [
                  "/media/brick-church-apartments.webp",
                  "Apartment blocks and parking at The Crossings",
                ],
              ].map(([src, cap]) => (
          ...
          <Reveal delay={80} className="md:order-1">
            ...
            >
              A 7.5-second nadir hold over NJDOT’s $20.3 million North Munn Avenue Bridge
              replacement over I-280 — steel, orange barrier, live interstate lanes — alongside
              daylight aerial stills of The Crossings: Embark apartments at Brick Church station and
              the new ShopRite. Same geography, two deliverables: the reconstruction, and the
              redevelopment it sits in. Scheduled through spring 2028.
            </p>
            <Link
              to="/work/$slug"
